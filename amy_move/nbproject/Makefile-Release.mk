...
${OBJECTDIR}/src/amy/move/CyclicMove.o: src/amy/move/CyclicMove.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/amy/move/CyclicMove.o src/amy/move/CyclicMove.cpp

${OBJECTDIR}/src/amy/move/LinearCycler.o: src/amy/move/LinearCycler.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/amy/move
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/amy/move/LinearCycler.o src/amy/move/LinearCycler.cpp

${OBJECTDIR}/src/amy/move/MoveFactory.o: src/amy/move/MoveFactory.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/amy/move
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/amy/move/MoveFactory.o src/amy/move/MoveFactory.cpp

...
${OBJECTDIR}/src/amy/network/ArmData.o: src/amy/network/ArmData.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/amy/network/ArmData.o src/amy/network/ArmData.cpp

${OBJECTDIR}/src/amy/network/ArmNetwork.o: src/amy/network/ArmNetwork.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/amy/network
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/amy/network/ArmNetwork.o src/amy/network/ArmNetwork.cpp

${OBJECTDIR}/src/amy/network/DBArmStorage.o: src/amy/network/DBArmStorage.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/amy/network
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/amy/network/DBArmStorage.o src/amy/network/DBArmStorage.cpp
...
${OBJECTDIR}/src/amy/network/config/NetworkConfig.o: src/amy/network/config/NetworkConfig.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/amy/network/config/NetworkConfig.o src/amy/network/config/NetworkConfig.cpp

${OBJECTDIR}/src/amy/network/db/DBClient.o: src/amy/network/db/DBClient.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/amy/network/db
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/amy/network/db/DBClient.o src/amy/network/db/DBClient.cpp

${OBJECTDIR}/src/amy/network/db/DBConnection.o: src/amy/network/db/DBConnection.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/amy/network/db
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/amy/network/db/DBConnection.o src/amy/network/db/DBConnection.cpp

${OBJECTDIR}/src/amy/network/db/Database.o: src/amy/network/db/Database.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/amy/network/db
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/amy/network/db/Database.o src/amy/network/db/Database.cpp

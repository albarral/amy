...
namespace amy
{
// Class used to compute required JointMove commands & cruise speeds needed to perform specific move steps.
// This move steps (2D) are defined by a direction angle and a desired speed.
    
class ArmComputer
{
public:    
   // computes required JointMove commands for the given movement
   static void computeMovement(Movement& oMovement);
   // computes required JointMove commands for the given move step 

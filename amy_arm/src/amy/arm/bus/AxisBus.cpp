...
std::string AxisBus::toString()
{
    std::string text = "AxisBus:[" + axisName + "]\n" +       
         ...
         "CO_AXIS_TRIGGER: " + std::to_string(CO_AXIS_TRIGGER.getRequested()) + " - " + std::to_string(CO_AXIS_TRIGGER.getValue()) + "\n" +
         "CO_AXIS_STOP: " + std::to_string(CO_AXIS_STOP.getRequested()) + " - " + std::to_string(CO_AXIS_STOP.getValue()) + "\n" +

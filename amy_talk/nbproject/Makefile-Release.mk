...
${OBJECTDIR}/src/amy/talk/DataBlockAxes.o: src/amy/talk/DataBlockAxes.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/amy/talk/DataBlockAxes.o src/amy/talk/DataBlockAxes.cpp

${OBJECTDIR}/src/amy/talk/DataBlockJointDrivers.o: src/amy/talk/DataBlockJointDrivers.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/amy/talk
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/amy/talk/DataBlockJointDrivers.o src/amy/talk/DataBlockJointDrivers.cpp

${OBJECTDIR}/src/amy/talk/DataBlockJoints.o: src/amy/talk/DataBlockJoints.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/amy/talk
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/amy/talk/DataBlockJoints.o src/amy/talk/DataBlockJoints.cpp

...
${OBJECTDIR}/src/amy/server/AmyServer.o: src/amy/server/AmyServer.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/amy/server/AmyServer.o src/amy/server/AmyServer.cpp

${OBJECTDIR}/src/amy/server/file/AmyFileServer.o: src/amy/server/file/AmyFileServer.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/amy/server/file
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/amy/server/file/AmyFileServer.o src/amy/server/file/AmyFileServer.cpp

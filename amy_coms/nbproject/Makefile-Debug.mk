...
LDLIBSOPTIONS=-Wl,-rpath,'../amy_core/dist/Debug/GNU-Linux' -L../amy_core/dist/Debug/GNU-Linux -lamy_core -Wl,-rpath,'../amy_utils/dist/Debug/GNU-Linux' -L../amy_utils/dist/Debug/GNU-Linux -lamy_utils /usr/local/lib/libzmq.so
...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libamy_coms.${CND_DLIB_EXT}: /usr/local/lib/libzmq.so
...
${OBJECTDIR}/src/amy/coms/dictionary/AxisCategory.o: src/amy/coms/dictionary/AxisCategory.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../amy_core/src -I../amy_utils/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/amy/coms/dictionary/AxisCategory.o src/amy/coms/dictionary/AxisCategory.cpp

${OBJECTDIR}/src/amy/coms/dictionary/ComsCategory.o: src/amy/coms/dictionary/ComsCategory.cpp
	${MKDIR} -p ${OBJECTDIR}/src/amy/coms/dictionary
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../amy_core/src -I../amy_utils/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/amy/coms/dictionary/ComsCategory.o src/amy/coms/dictionary/ComsCategory.cpp

${OBJECTDIR}/src/amy/coms/dictionary/ComsCommand.o: src/amy/coms/dictionary/ComsCommand.cpp
	${MKDIR} -p ${OBJECTDIR}/src/amy/coms/dictionary
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../amy_core/src -I../amy_utils/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/amy/coms/dictionary/ComsCommand.o src/amy/coms/dictionary/ComsCommand.cpp

${OBJECTDIR}/src/amy/coms/dictionary/ComsDictionary.o: src/amy/coms/dictionary/ComsDictionary.cpp
	${MKDIR} -p ${OBJECTDIR}/src/amy/coms/dictionary
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../amy_core/src -I../amy_utils/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/amy/coms/dictionary/ComsDictionary.o src/amy/coms/dictionary/ComsDictionary.cpp

${OBJECTDIR}/src/amy/coms/dictionary/CyclicCategory.o: src/amy/coms/dictionary/CyclicCategory.cpp
	${MKDIR} -p ${OBJECTDIR}/src/amy/coms/dictionary
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../amy_core/src -I../amy_utils/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/amy/coms/dictionary/CyclicCategory.o src/amy/coms/dictionary/CyclicCategory.cpp

${OBJECTDIR}/src/amy/coms/dictionary/JointCategory.o: src/amy/coms/dictionary/JointCategory.cpp
	${MKDIR} -p ${OBJECTDIR}/src/amy/coms/dictionary
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../amy_core/src -I../amy_utils/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/amy/coms/dictionary/JointCategory.o src/amy/coms/dictionary/JointCategory.cpp

${OBJECTDIR}/src/amy/coms/dictionary/OtherCategory.o: src/amy/coms/dictionary/OtherCategory.cpp
	${MKDIR} -p ${OBJECTDIR}/src/amy/coms/dictionary
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../amy_core/src -I../amy_utils/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/amy/coms/dictionary/OtherCategory.o src/amy/coms/dictionary/OtherCategory.cpp
...
${OBJECTDIR}/src/amy/coms/zero/AmyZeroMQSubscriber.o: src/amy/coms/zero/AmyZeroMQSubscriber.cpp
	${MKDIR} -p ${OBJECTDIR}/src/amy/coms/zero
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../amy_core/src -I../amy_utils/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/amy/coms/zero/AmyZeroMQSubscriber.o src/amy/coms/zero/AmyZeroMQSubscriber.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} -r ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libamy_utils.so ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libamy_core.so ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libzmq.so

...
${OBJECTDIR}/src/amy/control/module.o: src/amy/control/module.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/amy/control/module.o src/amy/control/module.cpp

${OBJECTDIR}/src/amy/control/module2.o: src/amy/control/module2.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/amy/control
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/amy/control/module2.o src/amy/control/module2.cpp

${OBJECTDIR}/src/amy/control/module3.o: src/amy/control/module3.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/amy/control
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/amy/control/module3.o src/amy/control/module3.cpp

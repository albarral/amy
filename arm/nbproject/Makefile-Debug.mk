...
${OBJECTDIR}/src/amy/arm/modules/AxisDriver2.o: src/amy/arm/modules/AxisDriver2.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/amy/arm/modules
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../amy_utils/src -I../amy_network/src -I../amy_show/src -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/amy/arm/modules/AxisDriver2.o src/amy/arm/modules/AxisDriver2.cpp

...
${OBJECTDIR}/src/amy/interface2/JointsClient.o: src/amy/interface2/JointsClient.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/amy/interface2
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../../tron/tron_coms/src -I../../tron/tron_topics/src -I../../tron/tron_util/src -I/usr/include/ignition/transport3 -I/usr/include/ignition/msgs0 -I/usr/include/ignition/math2 -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/amy/interface2/JointsClient.o src/amy/interface2/JointsClient.cpp
...
${OBJECTDIR}/src/amy/interface2/channels/AxesSection.o: src/amy/interface2/channels/AxesSection.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../../tron/tron_coms/src -I../../tron/tron_topics/src -I../../tron/tron_util/src -I/usr/include/ignition/transport3 -I/usr/include/ignition/msgs0 -I/usr/include/ignition/math2 -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/amy/interface2/channels/AxesSection.o src/amy/interface2/channels/AxesSection.cpp

${OBJECTDIR}/src/amy/interface2/channels/CyclerSection.o: src/amy/interface2/channels/CyclerSection.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/amy/interface2/channels
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../../tron/tron_coms/src -I../../tron/tron_topics/src -I../../tron/tron_util/src -I/usr/include/ignition/transport3 -I/usr/include/ignition/msgs0 -I/usr/include/ignition/math2 -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/amy/interface2/channels/CyclerSection.o src/amy/interface2/channels/CyclerSection.cpp

...
LDLIBSOPTIONS=-Wl,-rpath,../amy_math/dist/Debug/GNU-Linux -L../amy_math/dist/Debug/GNU-Linux -lamy_math -Wl,-rpath,../amy_talk/dist/Debug/GNU-Linux -L../amy_talk/dist/Debug/GNU-Linux -lamy_talk -Wl,-rpath,../../tron/comy/dist/Debug/GNU-Linux -L../../tron/comy/dist/Debug/GNU-Linux -ltron_comy -Wl,-rpath,../../tron/talky/dist/Debug/GNU-Linux -L../../tron/talky/dist/Debug/GNU-Linux -ltron_talky -Wl,-rpath,../../tron/tuly/dist/Debug/GNU-Linux -L../../tron/tuly/dist/Debug/GNU-Linux -ltron_tuly -Wl,-rpath,../../tron/tivy/dist/Debug/GNU-Linux -L../../tron/tivy/dist/Debug/GNU-Linux -ltron_tivy -lopencv_core -lopencv_highgui
...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libamy_show.${CND_DLIB_EXT}: ../amy_talk/dist/Debug/GNU-Linux/libamy_talk.so

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libamy_show.${CND_DLIB_EXT}: ../../tron/comy/dist/Debug/GNU-Linux/libtron_comy.so

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libamy_show.${CND_DLIB_EXT}: ../../tron/talky/dist/Debug/GNU-Linux/libtron_talky.so
...
${OBJECTDIR}/src/amy/show/AmyShow.o: src/amy/show/AmyShow.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../amy_math/src -I../amy_talk/src -I../../tron/comy/src -I../../tron/talky/src -I../../tron/tuly/src -I../../tron/tivy/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/amy/show/AmyShow.o src/amy/show/AmyShow.cpp

${OBJECTDIR}/src/amy/show/ShowData.o: src/amy/show/ShowData.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/amy/show
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../amy_math/src -I../amy_talk/src -I../../tron/comy/src -I../../tron/talky/src -I../../tron/tuly/src -I../../tron/tivy/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/amy/show/ShowData.o src/amy/show/ShowData.cpp

${OBJECTDIR}/src/amy/show/arm/ArmFrontView.o: src/amy/show/arm/ArmFrontView.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/amy/show/arm
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../amy_math/src -I../amy_talk/src -I../../tron/comy/src -I../../tron/talky/src -I../../tron/tuly/src -I../../tron/tivy/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/amy/show/arm/ArmFrontView.o src/amy/show/arm/ArmFrontView.cpp

${OBJECTDIR}/src/amy/show/arm/ArmPlot.o: src/amy/show/arm/ArmPlot.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/amy/show/arm
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../amy_math/src -I../amy_talk/src -I../../tron/comy/src -I../../tron/talky/src -I../../tron/tuly/src -I../../tron/tivy/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/amy/show/arm/ArmPlot.o src/amy/show/arm/ArmPlot.cpp

${OBJECTDIR}/src/amy/show/arm/ArmSideView.o: src/amy/show/arm/ArmSideView.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/amy/show/arm
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../amy_math/src -I../amy_talk/src -I../../tron/comy/src -I../../tron/talky/src -I../../tron/tuly/src -I../../tron/tivy/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/amy/show/arm/ArmSideView.o src/amy/show/arm/ArmSideView.cpp

${OBJECTDIR}/src/amy/show/modules/ShowPlotter.o: src/amy/show/modules/ShowPlotter.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/amy/show/modules
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../amy_math/src -I../amy_talk/src -I../../tron/comy/src -I../../tron/talky/src -I../../tron/tuly/src -I../../tron/tivy/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/amy/show/modules/ShowPlotter.o src/amy/show/modules/ShowPlotter.cpp

${OBJECTDIR}/src/amy/show/modules/ShowSenser.o: src/amy/show/modules/ShowSenser.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/amy/show/modules
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../amy_math/src -I../amy_talk/src -I../../tron/comy/src -I../../tron/talky/src -I../../tron/tuly/src -I../../tron/tivy/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/amy/show/modules/ShowSenser.o src/amy/show/modules/ShowSenser.cpp

${OBJECTDIR}/src/amy/show/plot/ArmPlotter.o: src/amy/show/plot/ArmPlotter.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/amy/show/plot
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../amy_math/src -I../amy_talk/src -I../../tron/comy/src -I../../tron/talky/src -I../../tron/tuly/src -I../../tron/tivy/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/amy/show/plot/ArmPlotter.o src/amy/show/plot/ArmPlotter.cpp

${OBJECTDIR}/src/amy/show/plot/HistoryPlotter.o: src/amy/show/plot/HistoryPlotter.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/amy/show/plot
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../amy_math/src -I../amy_talk/src -I../../tron/comy/src -I../../tron/talky/src -I../../tron/tuly/src -I../../tron/tivy/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/amy/show/plot/HistoryPlotter.o src/amy/show/plot/HistoryPlotter.cpp

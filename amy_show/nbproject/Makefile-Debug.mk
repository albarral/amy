...
${OBJECTDIR}/src/amy/show/AmyShow.o: src/amy/show/AmyShow.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../amy_math/src -I../amy_talk/src -I../../tron/comy/src -I../../tron/talky/src -I../../tron/tuly/src -I../../tron/tivy/src -I../amy_core/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/amy/show/AmyShow.o src/amy/show/AmyShow.cpp

${OBJECTDIR}/src/amy/show/arm/ArmFrontView.o: src/amy/show/arm/ArmFrontView.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/amy/show/arm
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../amy_math/src -I../amy_talk/src -I../../tron/comy/src -I../../tron/talky/src -I../../tron/tuly/src -I../../tron/tivy/src -I../amy_core/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/amy/show/arm/ArmFrontView.o src/amy/show/arm/ArmFrontView.cpp

${OBJECTDIR}/src/amy/show/arm/ArmPlot.o: src/amy/show/arm/ArmPlot.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/amy/show/arm
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../amy_math/src -I../amy_talk/src -I../../tron/comy/src -I../../tron/talky/src -I../../tron/tuly/src -I../../tron/tivy/src -I../amy_core/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/amy/show/arm/ArmPlot.o src/amy/show/arm/ArmPlot.cpp

${OBJECTDIR}/src/amy/show/arm/ArmSideView.o: src/amy/show/arm/ArmSideView.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/amy/show/arm
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../amy_math/src -I../amy_talk/src -I../../tron/comy/src -I../../tron/talky/src -I../../tron/tuly/src -I../../tron/tivy/src -I../amy_core/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/amy/show/arm/ArmSideView.o src/amy/show/arm/ArmSideView.cpp
...
${OBJECTDIR}/src/amy/show/modules/AmyDisplayer.o: src/amy/show/modules/AmyDisplayer.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../amy_math/src -I../amy_talk/src -I../../tron/comy/src -I../../tron/talky/src -I../../tron/tuly/src -I../../tron/tivy/src -I../amy_core/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/amy/show/modules/AmyDisplayer.o src/amy/show/modules/AmyDisplayer.cpp

${OBJECTDIR}/src/amy/show/modules/ArmPlotter.o: src/amy/show/modules/ArmPlotter.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/amy/show/modules
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../amy_math/src -I../amy_talk/src -I../../tron/comy/src -I../../tron/talky/src -I../../tron/tuly/src -I../../tron/tivy/src -I../amy_core/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/amy/show/modules/ArmPlotter.o src/amy/show/modules/ArmPlotter.cpp

${OBJECTDIR}/src/amy/show/modules/HistoryPlotter.o: src/amy/show/modules/HistoryPlotter.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/amy/show/modules
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../amy_math/src -I../amy_talk/src -I../../tron/comy/src -I../../tron/talky/src -I../../tron/tuly/src -I../../tron/tivy/src -I../amy_core/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/amy/show/modules/HistoryPlotter.o src/amy/show/modules/HistoryPlotter.cpp
